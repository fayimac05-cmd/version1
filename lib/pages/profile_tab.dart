          ...
          children: [
            ...
            Stack(
              ...
              children: [
                GestureDetector(
                  onTap: () => _snackbar(
                    'Photo de couverture — Upload disponible en production',
                  ),
                  child: Container(
                    height: 190,
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        ...
                        child: GestureDetector(
                          onTap: () => _snackbar(
                            'Photo de profil — Upload disponible en production',
                          ),
                          child: Container(
                            width: 32,
                            height: 32,
                  ...
                  _sectionCard(
                    ...
                    enfants: [
                      ...
                      _ligneModifiable(
                        ...
                        label: 'Téléphone',
                        valeur: _telVisible
                            ? (_telephone.isNotEmpty ? _telephone : '')
                            : '••• •• •• ••',
                        hint: 'Ajouter',
                        trailing: Switch(
                          value: _telVisible,
                    ...
                    enfants: [
                      Container(
                        ...
                        child: Column(
                          children: [
                            _confidRow(
                              'Profil visible par tous les membres',
                              true,
                              null,
                            ),
