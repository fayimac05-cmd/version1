...
class _ProfileTabState extends State<ProfileTab> with TickerProviderStateMixin {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: TextField(
                  controller: ctrl, maxLength: maxLength,
                  ...
                  decoration: InputDecoration(
                    ...
                    counterStyle: const TextStyle(color: Color(0xFF64748B), fontSize: 12),
                  ),
                ),
              ),
              const SizedBox(height: 16),
            ...
            child: GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                child: Stack(alignment: Alignment.center, children: [
                  Icon(
                    _panelOuvert ? Icons.notifications_rounded : Icons.notifications_outlined,
                    color: _panelOuvert ? AppPalette.blue : const Color(0xFF64748B),
                    size: 22,
                  ),
                  if (_nonLus > 0)
                    Positioned(top: 7, right: 7, child: _BadgePulse(count: _nonLus)),
                ]),
              ),
            ),
          ),
                  ...
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [Color(0xFF0A4DA2), Color(0xFF1565C0), Color(0xFF0D47A1)],
                      ),
                    ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (widget.profile.filiere.isNotEmpty) ...[
                    Container(
                      ...
                      child: Row(children: [
                        ...
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text(widget.profile.filiere, style: const TextStyle(
                              fontSize: 14, fontWeight: FontWeight.w700, color: Color(0xFF0F172A))),
                          if (widget.profile.domaine.isNotEmpty)
                            Text(widget.profile.domaine, style: const TextStyle(
                                fontSize: 12, color: AppPalette.blue, fontWeight: FontWeight.w600)),
                        ])),
                  ...
                  _sectionCard(
                    ...
                    enfants: [
                      GestureDetector(
                        onTap: () => _editer(titre: 'Biographie', valeur: _bio,
                            hint: 'Parlez de vous...', maxLength: 300, maxLines: 4,
                  ...
                  _sectionCard(
                    ...
                    enfants: [
                      ...
                      _div(),
                      _ligneModifiable(icon: Icons.location_on_outlined, label: 'Ville / Localité',
                          valeur: _ville, hint: 'Ajouter',
                          onTap: () => _editer(titre: 'Ville', valeur: _ville,
                              hint: 'Ex: Ouagadougou, Burkina Faso',
                              onSave: (v) => setState(() => _ville = v))),
                      _div(),
                      _ligneModifiable(icon: Icons.cake_outlined, label: 'Date de naissance',
                          valeur: _dateNaiss, hint: 'Optionnel',
                  ...
                  _sectionCard(
                    ...
                    enfants: [
                      _ligneFixe(Icons.badge_outlined, 'Matricule', widget.profile.matricule),
                      _div(),
                      _ligneFixe(Icons.menu_book_outlined, 'Filière',
                          widget.profile.filiere.isNotEmpty ? widget.profile.filiere : 'Non renseignée'),
                      _div(),
                  ...
                  _sectionCard(
                    ...
                    enfants: [
                      _ligneModifiable(icon: Icons.facebook, label: 'Facebook',
                          valeur: _facebook, hint: 'Ajouter', iconColor: const Color(0xFF1877F2),
                          onTap: () => _editer(titre: 'Facebook', valeur: _facebook,
                              hint: 'facebook.com/votre-profil',
                              onSave: (v) => setState(() => _facebook = v))),
                      _div(),
                      _ligneModifiable(icon: Icons.chat_outlined, label: 'WhatsApp',
                          valeur: _whatsapp, hint: 'Ajouter', iconColor: const Color(0xFF25D366),
                          onTap: () => _editer(titre: 'WhatsApp', valeur: _whatsapp,
                              hint: '+226 XX XX XX XX',
                              onSave: (v) => setState(() => _whatsapp = v))),
                      _div(),
                      _ligneModifiable(icon: Icons.work_outline, label: 'LinkedIn',
                          valeur: _linkedin, hint: 'Ajouter', iconColor: const Color(0xFF0A66C2),
                          onTap: () => _editer(titre: 'LinkedIn', valeur: _linkedin,
  ...
  Widget _sectionCard({
    required String titre, required IconData icon,
    required Color couleur, required List<Widget> enfants, String? badge,
  }) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Padding(padding: const EdgeInsets.all(16), child: Column(children: enfants)),
      ]),
    );
  }

  Widget _ligneModifiable({
    required IconData icon, required String label, required String valeur,
    required VoidCallback onTap, String? hint, Color? iconColor, Widget? trailing,
  }) {
    ...
    return GestureDetector(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(empty ? (hint ?? 'Appuyez pour modifier') : valeur,
  ...
  Widget _ligneFixe(IconData icon, String label, String valeur) {
    return Row(children: [
      ...
      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text(label, style: const TextStyle(fontSize: 12, color: Color(0xFF64748B), fontWeight: FontWeight.w500)),
        const SizedBox(height: 2),
        Text(valeur, style: const TextStyle(fontSize: 15, color: Color(0xFF0F172A), fontWeight: FontWeight.w500)),
      ])),
  ...
  void _confirmerDeconnexion() {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        title: const Text('Se déconnecter', style: TextStyle(fontSize: 18,
            fontWeight: FontWeight.bold, color: Color(0xFF0F172A))),
        ...
        actions: [
          TextButton(
            onPressed: () => Navigator.of(context).pop(),
            child: const Text('Annuler', style: TextStyle(fontSize: 15, color: Color(0xFF64748B))),
          ),
          ElevatedButton(
            onPressed: () {
              Navigator.of(context).pop();
...
class _NotifPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(children: [
      Positioned.fill(child: GestureDetector(onTap: onFermer,
        ...
        child: Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            Padding(padding: const EdgeInsets.fromLTRB(16, 14, 12, 10), child: Row(children: [
              const Expanded(child: Text('Notifications', style: TextStyle(fontSize: 15,
                  fontWeight: FontWeight.bold, color: Color(0xFF0F172A)))),
              ...
              const SizedBox(width: 8),
              if (nonLus > 0) TextButton(
                onPressed: onToutLu,
                style: TextButton.styleFrom(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                    minimumSize: Size.zero, tapTargetSize: MaterialTapTargetSize.shrinkWrap),
                child: const Text('Tout lire', style: TextStyle(fontSize: 12, color: Color(0xFF0A4DA2))),
              ),
            ])),
            const Divider(height: 1, color: Color(0xFFE2E8F0)),
            Flexible(child: ListView.separated(
              ...
              separatorBuilder: (_, __) => const Divider(height: 1, color: Color(0xFFF1F5F9), indent: 60),
            ...
            TextButton(
              ...
              child: const Text('Voir toutes les notifications',
                  style: TextStyle(fontSize: 13, color: Color(0xFF0A4DA2), fontWeight: FontWeight.w600)),
            ),
          ]),
        ),
      )),
...
class _NotifItem extends StatelessWidget {
  ...
  Color get _bg {
    switch (notif.type) {
      case NotifType.examen:      return const Color(0xFFFCEBEB);
      case NotifType.note:        return const Color(0xFFFAEEDA);
      case NotifType.cours:       return const Color(0xFFE6F1FB);
      case NotifType.inscription: return const Color(0xFFEAF3DE);
      case NotifType.message:     return const Color(0xFFEEEDFE);
    }
  }

  Color get _iconColor {
    switch (notif.type) {
      case NotifType.examen:      return const Color(0xFFA32D2D);
      case NotifType.note:        return const Color(0xFF854F0B);
      case NotifType.cours:       return const Color(0xFF185FA5);
      case NotifType.inscription: return const Color(0xFF3B6D11);
      case NotifType.message:     return const Color(0xFF534AB7);
    }
  }

  IconData get _icone {
    switch (notif.type) {
      case NotifType.examen:      return Icons.alarm_outlined;
      case NotifType.note:        return Icons.star_outline_rounded;
      case NotifType.cours:       return Icons.menu_book_outlined;
      case NotifType.inscription: return Icons.check_circle_outline;
      ...
      child: Container(
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Container(width: 36, height: 36,
              ...
              child: Icon(_icone, color: _iconColor, size: 18)),
          const SizedBox(width: 10),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: 2),
            Text(notif.corps, style: const TextStyle(fontSize: 12, color: Color(0xFF64748B), height: 1.4),
                maxLines: 2, overflow: TextOverflow.ellipsis),
            const SizedBox(height: 4),
            Text(notif.temps, style: const TextStyle(fontSize: 11, color: Color(0xFF94A3B8))),
          ])),
        ]),
      ),
    );
