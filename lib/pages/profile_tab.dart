...
// ════════════════════════════════════════════════════════════════════════════
// PROFILE TAB  —  cloche supprimée (notifications → accueil)
// ════════════════════════════════════════════════════════════════════════════
...
class _ProfileTabState extends State<ProfileTab> with TickerProviderStateMixin {
  ...
  void _editer({
    ...
    int maxLength = 200, int maxLines = 1,
        ...
        child: Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min,
            ...
            Container(
              ...
              child: TextField(controller: ctrl, maxLength: maxLength,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        scrolledUnderElevation: 1, shadowColor: const Color(0xFFE2E8F0),
      ),
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              if (widget.profile.filiere.isNotEmpty) ...[
                Container(
                  ...
                  decoration: BoxDecoration(color: AppPalette.softYellow,
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(widget.profile.filiere, style: const TextStyle(fontSize: 14,
              ...
              _sectionCard(titre: 'Biographie', icon: Icons.edit_outlined,
                couleur: AppPalette.blue, enfants: [
                  GestureDetector(
              ...
              _sectionCard(titre: 'Informations personnelles', icon: Icons.person_outline,
                couleur: AppPalette.blue, enfants: [
              ...
              _sectionCard(titre: 'Informations académiques', icon: Icons.school_outlined,
                couleur: AppPalette.blue, badge: "🔒 Géré par l'admin", enfants: [
              ...
              _sectionCard(titre: 'Réseaux sociaux', icon: Icons.link,
                couleur: const Color(0xFF0891B2), badge: 'Optionnel', enfants: [
              ...
              _sectionCard(titre: 'Confidentialité', icon: Icons.privacy_tip_outlined,
                couleur: const Color(0xFF7C3AED), enfants: [
                  Container(
  ...
  Widget _sectionCard({required String titre, required IconData icon,
  ...
  Widget _ligneModifiable({required IconData icon, required String label,
    required String valeur, required VoidCallback onTap,
    String? hint, Color? iconColor, Widget? trailing}) {
  ...
  Widget _ligneFixe(IconData icon, String label, String valeur) => Row(children: [
    Container(width: 40, height: 40,
  ...
  Widget _div() => const Padding(padding: EdgeInsets.symmetric(vertical: 10),
  ...
  void _snackbar(String msg) => ScaffoldMessenger.of(context).showSnackBar(
