...
class _CanalScreenState extends State<CanalScreen> {
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _carteCanal(
                    ...
                    nom: 'Administration',
                    description:
                        'Annonces officielles et informations pédagogiques',
                  ...
                  _carteCanal(
                    ...
                    nom: 'Admin & Filière',
                    description:
                        'Messages ciblés Admin+Délégué → votre filière',
                  ...
                  _carteCanal(
                    ...
                    description:
                        'Posez une question en privé à l\'administration',
    ...
    switch (type) {
      ...
      case 'admin_filiere':
        page = _CanalDetail(
          ...
          avatar: '📢',
          couleur: const Color(0xFF0891B2),
          tag: peutEcrireAdminFiliere
              ? 'Broadcast · Vous pouvez écrire'
              : 'Broadcast',
  ...
  List<_MessageCanal> _msgsAdmin() => [
    ...
    _MessageCanal(
      id: 'A3',
      expediteur: 'Scolarité',
      initiales: 'SC',
      texte:
          'Les inscriptions pédagogiques pour le Semestre 4 sont ouvertes jusqu\'au 05 Mai 2026.',
      heure: '10:30',
      date: 'Aujourd\'hui',
      type: 'texte',
    ...
    _MessageCanal(
      ...
      initiales: 'DP',
      texte:
          'Rappel : La bibliothèque est ouverte de 8h à 20h du lundi au samedi.',
      heure: '08:00',
      date: 'Hier',
      type: 'texte',
      color: AppPalette.blue,
  ...
  List<_MessageCanal> _msgsAdminFiliere() => [
    _MessageCanal(
      ...
      initiales: 'AD',
      texte:
          '📢 Rappel : examen de Réseaux & Protocoles le 10 Mai à 8h en salle B2.',
      heure: '14:00',
      date: 'Aujourd\'hui',
      type: 'texte',
      color: const Color(0xFF0891B2),
  ...
  List<_MessageCanal> _msgsBDE() => [
    _MessageCanal(
      id: 'B1',
      expediteur: 'BDE — Aïcha S.',
      initiales: 'AS',
      texte:
          '🎵 SOIRÉE ÉTUDIANTE — Vendredi 02 Mai 2026\n\n📍 Campus IST\n🎟️ Entrée : 500 FCFA via Orange Money\n\nVenez nombreux ! 🔥',
      heure: '18:30',
      date: 'Hier',
      type: 'texte',
      color: const Color(0xFF7C3AED),
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText:
                        'Message en tant que ${widget.profile.roleLabel}...',
