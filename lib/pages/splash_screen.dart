...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    _sloganCtrl = AnimationController(vsync: this,
        duration: const Duration(milliseconds: 600));
    _sloganOpacity = Tween<double>(begin: 0.0, end: 1.0).animate(
        CurvedAnimation(parent: _sloganCtrl, curve: Curves.easeIn));

    _citationCtrl = AnimationController(vsync: this,
        duration: const Duration(milliseconds: 700));
    _citationOpacity = Tween<double>(begin: 0.0, end: 1.0).animate(
        CurvedAnimation(parent: _citationCtrl, curve: Curves.easeIn));
  ...
  @override
  void dispose() {
    _logoCtrl.dispose(); _textCtrl.dispose(); _sloganCtrl.dispose();
    _citationCtrl.dispose(); _btnCtrl.dispose();
    super.dispose();
  }
      ...
      body: Container(
        ...
        child: Stack(children: [
          ...
          Positioned(top: -80, left: -80,
              child: _circle(260, _blueMid, 0.3)),
          Positioned(bottom: -100, right: -100,
              child: _circle(320, _blueMid, 0.25)),
          Positioned(top: size.height * 0.35, right: -50,
              child: _circle(160, _yellow, 0.08)),
          Positioned(bottom: size.height * 0.3, left: -40,
              child: _circle(130, _yellow, 0.06)),
          Positioned(top: size.height * 0.1, right: size.width * 0.1,
              child: _circle(50, _yellow, 0.18)),
          Positioned(bottom: size.height * 0.18, left: size.width * 0.12,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // ③ Slogan
                      FadeTransition(opacity: _sloganOpacity,
                          child: _buildSlogan(mobile)),

                      const SizedBox(height: 32),

                      // ④ Citation burkinabè
                      FadeTransition(opacity: _citationOpacity,
                          child: _buildCitation(mobile)),

                      const Spacer(flex: 3),

                      // ⑤ Bouton
                      FadeTransition(opacity: _btnOpacity,
  ...
  Widget _buildTitre(bool mobile) => Text('ScolarHub',
    textAlign: TextAlign.center,
    style: TextStyle(fontSize: mobile ? 44 : 52,
  ...
  Widget _buildSlogan(bool mobile) => Text(
    ...
    style: TextStyle(fontSize: mobile ? 16 : 18,
        color: _yellowL,
        fontStyle: FontStyle.italic, height: 1.55, letterSpacing: 0.3),
  );
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Text('— Proverbe burkinabè',
          style: TextStyle(fontSize: mobile ? 12 : 14,
              color: _yellow, fontWeight: FontWeight.w700, letterSpacing: 0.5)),
    ]),
  );
