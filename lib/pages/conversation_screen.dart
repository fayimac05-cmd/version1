      ...
      children: [
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Text(
                _messageARepondre!.estMoi ? 'Vous' : _contact.prenoms,
                style: const TextStyle(
                  fontSize: 11,
                  fontWeight: FontWeight.w700,
                  color: Color(0xFF00A884),
  ...
  Widget _zoneSaisie() => Container(
    ...
    child: Row(
      ...
      children: [
        ...
        if (!_hasText) _iconBtn(Icons.add_rounded, _menuPieceJointe),
