...
class ConversationPrivee {
  ...
  MessagePrive? get dernierMessage => messages.isEmpty ? null : messages.last;
...
class _MessagesScreenState extends State<MessagesScreen> {
  ...
  List<ConversationPrivee> get _filtres {
    ...
    return conversationsPrivees
        .where(
          (c) =>
              c.contact.nomComplet.toLowerCase().contains(_query.toLowerCase()),
        )
        .toList();
  }
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          dernMsg == null
                              ? ''
                              : dernMsg.type == TypeMessagePrive.image
                              ? '📷 Photo'
                              : dernMsg.type == TypeMessagePrive.document
                              ? '📄 Document'
                              : dernMsg.type == TypeMessagePrive.vocal
                              ? '🎤 Vocal'
                              : dernMsg.type == TypeMessagePrive.sticker
                              ? '😊 Sticker'
                              : dernMsg.texte,
                          style: TextStyle(
                            fontSize: 12,
      ...
      builder: (_) => SafeArea(
        child: Column(
          ...
          children: [
            ...
            ListTile(
              leading: Icon(
                c.epingle ? Icons.push_pin_outlined : Icons.push_pin_rounded,
                color: AppPalette.blue,
              ),
  ...
  void _ouvrirOuCreer(ContactEtudiant e) {
    ...
    setState(() {
      conversationsPrivees.insert(0, n);
      _convActive = n;
    });
  }
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text(
              'Numéro enregistré sur le compte ScolarHub.',
              style: TextStyle(fontSize: 13, color: Color(0xFF64748B)),
            ),
    ...
    actions: [
      ...
      PopupMenuButton<String>(
        ...
        itemBuilder: (_) => const [
          ...
          PopupMenuItem(value: 'effacer', child: Text('Effacer la discussion')),
        ],
      ),
    ],
  );
      ...
      builder: (_) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _act(
              msg.important ? Icons.star_rounded : Icons.star_outline_rounded,
              msg.important
            ...
            _act(Icons.share_rounded, 'Partager', const Color(0xFF54656F), () {
              Navigator.pop(context);
              _snack('📤 Partage...');
            }),
            if (!msg.estMoi)
      ...
      builder: (_) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _mitem(Icons.poll_outlined, 'Sondage', const Color(0xFF0D6EFD), () {
              Navigator.pop(context);
              _snack('📊 Sondage');
            }),
            _mitem(
