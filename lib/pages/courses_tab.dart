...
class _CoursesTabState extends State<CoursesTab> {
  ...
  final List<Map<String, dynamic>> _cours = [
    {
      'module': 'Algorithmique & Structures',
      'titre': 'Chapitre 3 — Les pointeurs',
      'prof': 'Prof Ouédraogo',
      'date': 'Aujourd\'hui, 09h32',
      'taille': '2.4 MB',
      'nouveau': true,
    ...
    },
    {
      ...
      'titre': 'Chapitre 5 — Jointures SQL',
      'prof': 'Prof Traoré',
      'date': 'Hier, 14h15',
      'taille': '1.8 MB',
      'nouveau': true,
    ...
    },
    {
      ...
      'titre': 'Cours 4 — Théorie des graphes',
      'prof': 'Prof Kaboré',
      'date': '23 Avr, 11h20',
      'taille': '4.2 MB',
      'nouveau': false,
  ...
  List<Map<String, dynamic>> get _filtered => _cours.where((c) {
    final matchMod =
        _moduleSelectionne == 'Tous' || c['module'] == _moduleSelectionne;
    final matchQ =
        _recherche.isEmpty ||
        (c['titre'] as String).toLowerCase().contains(
          _recherche.toLowerCase(),
        ) ||
        (c['module'] as String).toLowerCase().contains(
          _recherche.toLowerCase(),
        ) ||
          ...
          AppPageHeader(
            ...
            trailing: _nbNouveaux > 0
                ? Container(
                    ...
                    child: Text(
                      '$_nbNouveaux nouveau${_nbNouveaux > 1 ? 'x' : ''}',
  ...
  Widget _coursCard(Map<String, dynamic> cours) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isNew ? color.withValues(alpha: 0.4) : const Color(0xFFE2E8F0),
          width: isNew ? 1.5 : 1,
        ),
        boxShadow: [
          BoxShadow(
