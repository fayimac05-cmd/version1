...
class _AuthPageState extends State<AuthPage> {
  ...
  void _verifier() async {
    ...
    if (_tab == 0) {
      ...
      if (user == null) {
        _setError(
          'Matricule non reconnu dans ${widget.etablissement.abreviation}.\nContactez l\'administration.',
        );
        return;
      }
      setState(() {
    ...
    setState(
      () => _etape = _userTrouve!['premiereFois'] == true
          ? _Etape.premiereFois
          : _Etape.motDePasse,
    );
  }
  ...
  child: OutlinedButton.icon(
    ...
    style: OutlinedButton.styleFrom(
      ...
      shape: RoundedRectangleBorder(
          ...
          const Center(
            child: Text(
              '24IST-O2/1851 · IST Campus Ouaga 2000',
              style: TextStyle(
                fontSize: 12,
                color: Color(0xFF64748B),
          ...
          const Center(
            child: Text(
              'Professeur - Programme, classe, cours et notes',
              style: TextStyle(
                fontSize: 12,
                color: Color(0xFF64748B),
                fontStyle: FontStyle.italic,
