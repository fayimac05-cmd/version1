...
class _AuthPageState extends State<AuthPage> {
  ...
  Future<void> _verifier() async {
    ...
    if (_tab == 0) {
      // Connexion par matricule (Étudiant, Admin, BDE)
  ...
  Future<void> _creerCompte() async {
    ...
    if (_newPassCtrl.text.length < 4) {
      _setError('Mot de passe : minimum 4 caractères.');
      return;
    }
  ...
  Widget _buildEtape() {
    switch (_etape) {
      ...
      case _Etape.motDePasse:
        return _buildMotDePasse();
      case _Etape.premiereFois:
        return _buildPremiereFois();
    }
  }

  // ─── Écran 1 : Saisie identifiants ─────────────────────────────────────────
    ...
    return Column(
      ...
      children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    e.campus.isNotEmpty ? '${e.nom} · ${e.campus}' : e.nom,
        ...
        if (e.abreviation == 'IST') ...[
          _demoBtn(
            '⚡',
            'Accès Démo — Ibrahim KOURAOGO',
            '24IST-O2/1851 · Étudiant RIT L2',
            AppPalette.blue,
            _demoBrahim,
          ),
          ...
          _demoBtn(
            '🎓',
            'Accès Démo — BDE (Aïcha)',
            '24IST-BDE/001 · Bureau des Étudiants',
          ...
          _demoBtn(
            '🛡️',
            'Accès Démo — Administration',
            '24IST-ADM/001 · Direction Pédagogique',
          ...
          _demoBtn(
            '👨‍🏫',
            'Accès Démo — Professeur',
            'OUÉDRAOGO Mamadou · Algorithmes & Réseaux',
          ...
          _demoBtn(
            '👨‍👩‍👦',
            'Accès Démo — Parent',
            "KOURAOGO Seydou · Parent d'Ibrahim",
  ...
  Widget _carteUser(Map<String, dynamic> u) {
    ...
    switch (role) {
      case 'etudiant':
        ...
        break;
      case 'professeur':
        rc = const Color(0xFF7C3AED);
        rl = 'Professeur';
        break;
      case 'admin':
        rc = const Color(0xFF1A3C34);
        rl = 'Administration';
        break;
      case 'bde':
        rc = const Color(0xFF0891B2);
        rl = 'Bureau des Étudiants';
        break;
      case 'parent':
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text(
              'Un lien sera envoyé à votre adresse email.',
              style: TextStyle(
                fontSize: 14,
                color: Color(0xFF64748B),
                height: 1.5,
